    ...
    return (
        <div className='bg-black'>
            <div className='flex flex-col gap-3 p-3 sm:gap-6 sm:p-5 lg:gap-8 lg:p-10'>
                {/* salary  */}
                <div>
                    <p className='text-lg sm:text-xl lg:text-2xl'>Expection Salary</p>
                    <input 
                    type="text" 
                ...
                <div className='flex flex-col gap-1 sm:gap-2 lg:gap-3'>
                    <p className='text-lg sm:text-xl lg:text-2xl'>Attach Projects</p>
                    ...
                    className='h-32 p-1.5 text-xs w-full bg-gray-100 outline-none sm:p-2 sm:text-base lg:p-4 lg:text-lg hover:border-2 hover:border-green-500 focus:border-2 focus:border-green-500 ' placeholder='Project Description...'></textarea>
                ...
                {/* job description  */}
                <div className='flex flex-col gap-1 sm:gap-2 lg:gap-3'>
                    <p className='text-lg sm:text-xl lg:text-2xl'>Purposal Letter</p>
                    <textarea 
                    value={proposalLetter}
                    onChange={(e) => setProposalLetter(e.target.value)}
                    className='h-80 w-full p-1.5 text-xs bg-gray-100 outline-none sm:p-2 sm:text-base lg:p-4 lg:text-lg hover:border-2 hover:border-green-500 focus:border-2 focus:border-green-500 ' placeholder='Purposal Letter...'></textarea>
                </div>
                ...
                <NavLink to='/appliedjob'>
                    <div>
                        <button 
                        className='w-24 text-base font-semibold px-1.5 py-1  sm:text-lg sm:font-semibold sm:w-28 lg:text-xl lg:font-bold lg:px-2.5 lg:py-2 lg:w-32 rounded-2xl bg-green-500 hover:bg-green-700 pointer-coarse:' 
