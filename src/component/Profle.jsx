      ...
      <div className='p-10'>
        ...
        <div className='flex justify-between'>
          <div className='pt-5 flex flex-col gap-5'>
            ...
            {/* name  */}
            <p className='text-2xl font-bold'>Nil Nil</p>
        ...
        <div className='flex flex-col pt-8 gap-2'>
          ...
          <div className='flex flex-col gap-1'>
            <p className='text-xl font-semibold'>Completed Project: 5</p>
            <p className='text-xl font-semibold'>Ongoing Project: 1</p>
        ...
        <div className="flex flex-col pt-8 gap-2">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-xl font-semibold">+2 in Computer Science</p>
            <p className="text-xl font-semibold">Bachelor's in Computer Science</p>
          </div>
        </div>
        ...
        <div className="flex flex-col pt-8 gap-2">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-xl font-semibold">1 year as Frontend Developer at Sipalaya Info Tech</p>
            <p className="text-xl font-semibold">2 years remote experience as Frontend Developer</p>
          </div>
        </div>
        ...
        <div className="flex flex-col pt-8 gap-2">
          ...
          <div className="flex flex-col gap-1">
            <p className="text-xl font-semibold">Amazon UI Clone (React.js + Tailwind CSS)</p>
            <p className="text-xl font-semibold">Job Portal Website</p>
          </div>
        </div>
