            ...
            <div className='flex flex-col gap-8 p-10'>
              ...
              <div className='flex flex-col gap-2'>
                ...
                <div className='flex gap-1'>
                  ...
                  <p className='text-xl font-bold'>@veerasystem</p>
                </div>
                ...
                <div className='flex gap-2 items-center'>
                  ...
                  <p className='text-xl font-bold'>$20,000 - $40,000</p>
                </div>
              </div>
              ...
              <div className='flex flex-col gap-3'>
                ...
                <div className='w-full flex gap-4'>
                  <div className='h-60 w-60 flex-shrink-0'>
                    <img src={""} className='h-full w-full outline-none object-cover border-3 border-white hover:border-green-500' />
                  </div >
